...
const Profile = () => {
  ...
  const handleGrantAdmin = () => {
    ...
    fetch(`https://refactored-cod-v6ww469vp657fwqpw-8000.app.github.dev/api/grant-admin`, {
      method: 'POST',
  ...
  useEffect(() => {
    ...
    fetch(`https://refactored-cod-v6ww469vp657fwqpw-8000.app.github.dev/api/main/${user.id}`)
      .then(res => res.json())
      .then(data => {
